        ...
        <div className="reload-loader" aria-label="Loading">
          ...
          <div className="reload-aircraft-orbit" aria-hidden="true">
            ...
            <svg className="reload-tail-dots-svg" viewBox="0 0 100 100">
              {/* Radius is 38.5, center is (50, 50). Aircraft sits around angle 80°-90° (top). Tail center is at ~68°. Dots trail backwards around circle */}
              <circle cx="36.5" cy="14.2" r="2.2" fill="#172554" opacity="0.95" />
              <circle cx="33.0" cy="15.8" r="2.1" fill="#172554" opacity="0.90" />
              <circle cx="29.6" cy="17.9" r="2.0" fill="#172554" opacity="0.85" />
              <circle cx="26.3" cy="20.3" r="1.9" fill="#172554" opacity="0.80" />
              <circle cx="23.3" cy="23.1" r="1.8" fill="#172554" opacity="0.75" />
              <circle cx="20.5" cy="26.3" r="1.7" fill="#172554" opacity="0.70" />
              <circle cx="18.0" cy="29.8" r="1.6" fill="#172554" opacity="0.65" />
              <circle cx="15.9" cy="33.6" r="1.5" fill="#172554" opacity="0.60" />
              <circle cx="14.1" cy="37.6" r="1.4" fill="#172554" opacity="0.55" />
              <circle cx="12.7" cy="41.9" r="1.3" fill="#172554" opacity="0.50" />
              <circle cx="11.8" cy="46.3" r="1.2" fill="#172554" opacity="0.45" />
              <circle cx="11.5" cy="50.8" r="1.2" fill="#172554" opacity="0.40" />
